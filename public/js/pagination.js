...
var Pagination = function (el, options) {
	...
	var $container = $(el),
		...
		firstPageLabel = options.labels.first || '<i class="fa fa-angle-double-left"></i>',
		lastPageLabel = options.labels.last || '<i class="fa fa-angle-double-right"></i>',
		nextPageLabel = options.labels.next || '<i class="fa fa-angle-right"></i>',
		previousPageLabel = options.labels.previous || '<i class="fa fa-angle-left"></i>',
