...
<html lang="en">
    ...
    <head> 
        <meta charset="utf-8" />
        <title>Persediaan Barang CV. SARANA TEKSTIL | Login</title>
        ...
        <link href="{{ asset('layout/css/login.min.css') }}" rel="stylesheet" type="text/css"> 
    ...
    -->
        ...
        <div class="copyright"> 2018 © Persediaan Barang CV. SARANA TEKSTIL </div>
        ...
        <script src="{{ asset('plugins/jquery-validation/jquery.form.js') }}" type="text/javascript"></script>
