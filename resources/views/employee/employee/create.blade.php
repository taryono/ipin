...
<form class="form-horizontal" method="POST" action="{{ route('employee.store') }}">
    ...
    <div class="form-group{{ $errors->has('phone_number') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input id="name" type="number" class="form-control" name="phone_number" value="{{ old('phone_number') }}" required autofocus>
    ...
    <div class="form-group{{ $errors->has('date_of_birth') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6">
            <input id="name" type="date" class="form-control" name="date_of_birth" value="{{ old('date_of_birth') }}" required autofocus>
    ...
    <div class="form-group{{ $errors->has('sex') ? ' has-error' : '' }}">
        ...
        <div class="col-md-6"> 
            <label class="radio-inline">
                <input id="name" type="radio" class="radio" name="sex" value="M" required autofocus checked>Laki - laki
            </label>
            <label class="radio-inline">
                <input id="name" type="radio" class="radio" name="sex" value="F" required autofocus>Perempuan
            </label>
            @if ($errors->has('sex'))
            <span class="help-block">
    ...
    <div class="form-group{{ $errors->has('position_id') ? ' has-error' : '' }}">
        <label for="position_id" class="col-md-4 control-label">Kategori Jabatan</label>
        <div class="col-md-6">
            <select name="position_id" class="form-control" id="example-getting-started">
