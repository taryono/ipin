<table class="table table-striped table-check data-table"> 
    <thead>
        <tr class="header"> 
            <th width="50px" nowrap="nowrap">@if($shipping_order_details->count()>0 && $shipping_order_details[0])<input type="checkbox" class="checked_ids"><div>@endif</th>
            <th>No</th> 
            <th>Kode</th>   
            <th>Nama</th>   
            <th>Stok</th> 
    ...
    <tbody> 
        ...
        <tr class="ordering">
            ...
            <th nowrap="nowrap" class="counted">
                <input type="hidden" name="shipping_order_id[{{$c->goods->id}}]" value="{{$c->shipping_order_id}}"> 
