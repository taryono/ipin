     ...
     <div class="row">
         <div class="col-md-12">
             <div class="panel panel-default">
                 <div class="panel-heading">List Kategori <div style="text-align: right">{!!getActions('category', 'create')?getActions('category', 'create'):NULL!!}</div>
                 </div>
                 ...
                 <div class="panel-body">
                     <table class="table table-striped table-check data-table">
                         ...
                         <thead>
                             <tr class="header">
                                 <th width="50px">@if($categories[0])<input type="checkbox" class="checked_ids"> &nbsp;<a href="" data-class="{{get_class($categories[0])}}" id="delete_all" data-model="Kategori"><i class="fa fa-trash" aria-hidden="true"></i></a>
                                     <div>@endif
                                 </th>
                                 <th>No</th>
                                 <th>Kode</th>
